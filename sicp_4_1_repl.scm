...
(define (evalM exp env)
  (cond ((self-evaluating? exp) exp)
	...
	;;((let*? exp) (evalM (let*->nested-lets exp) env))
	;;((let? exp) (evalM (let->combination exp) env))
	((application? exp) (apply (evalM (operator exp) env) (list-of-values (operands exp) env)))
